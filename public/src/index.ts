...
const coincidence: { [key: string]: string } = {
    a: "ai",
    e: "enter",
    i: "imes",
    o: "ober",
...
const newCoincidence: { [key: string]: string } = {
    ai: "a",
    enter: "e",
    imes: "i",
    ober: "o",
...
const encrypt = () => {
    ...
    if (!textArea) {
        ...
        textResult = textArea.value.toLowerCase().replace(
            /a|e|i|o|u/g,  (match) => {
...
if (!encryptedText) {
    ...
    secondTextResult = encryptedText.innerText.replace(
